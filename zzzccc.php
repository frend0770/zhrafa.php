...
$sudo = "1153088156"; //هنآ حط ايديك .
$chs = "ss_p_s"; // هنا حط قناتك بدون @ .
$ch = "@ss_p_s"; // هنا حط معرف قناتك مع الـ @ . 
...
'reply_markup'=>json_encode([
      'inline_keyboard'=>[ 
    [['text'=>"هنا حط اسم قناتك صديقي ،!" ,  'url'=>"https://t.me/$chs"]],
        ]
    ])
        ]);
}
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>" • ⚜┇تم زخرفهہ اسمڪ  بـ 22 شكلاً مختلفاً مع البايو ،  
⠀⠀◂⠀━━━━❊━━━━⠀▸",
'reply_markup'=>json_encode([
      'inline_keyboard'=>[
   [
